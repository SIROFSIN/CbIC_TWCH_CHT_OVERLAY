var channels = ['I_CbIC_I'], // Channels to initially join
	...
	showBadges = false, // Show chatters' badges
	...
	for(var i in emotes) {
		...
		for(var j in e) {
			...
			if(typeof mote == 'string') {
				...
				splitText.splice(mote[0], 1, '<img class="emoticon" src="http://static-cdn.jtvnw.net/emoticons/v2/' + i + '/default/light/1.0" />');
			}
		}
	}
